...
ยังไม่ทำ: ชนิดบล็อก รูป/วิดีโอ/ไฟล์/ลิงก์ ยังวาดไม่ได้ (แสดงป้าย
"ยังไม่รองรับ" แทนการซ่อน) · เชลล์เก่า `/home` → `pages/student/lesson_view_page.dart`
ยังแสดงแต่ `body` อยู่ตามเดิม
