...
| ✅ ค้นหาของ Student เป็นหน้าเต็มจอแบบ iOS + ค้นของจริง (2026-09-18) | ไดอะล็อกเดิมมีชิป "AIoT / วิทย์ / งานค้าง / **ครูสมชาย**" ฮาร์ดโค้ด กดแล้วแค่สลับแท็บ พิมพ์อะไรก็ไม่ค้น (ข้อมูลปลอมที่ผ่านตามาตั้งแต่ audit) → `student_search_page.dart`: ช่องค้นหา + "ยกเลิก", ว่าง = ทางลัดจริง (บทเรียน/ใบงาน/ปฏิทิน) + รายวิชาของฉัน, พิมพ์ = กรอง `listMyCourses` + `listAssignments` ต่อวิชา จัดกลุ่ม รายวิชา/ใบงาน, ไม่พบ = บอกพร้อมคำที่พิมพ์ · แตะวิชา → บทเรียนของวิชานั้น · เทสต์ 4 ตัว (390pt) · เพิ่มเติมวันเดียวกัน: hero เตี้ยลง/มาสคอตใหญ่/แถบขาว (`a2b452f` `268bd47` `64e40d8`), การ์ดเซนเซอร์หน้าแรกเป็นชิป 4×2 บนมือถือ (`8bee421`), ปฏิทินธีมเขียว (`cf256a9`), โปรไฟล์ชิดบน+hero (`a80deee`) |
