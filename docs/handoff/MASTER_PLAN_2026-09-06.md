...
| ~~D6~~ | ~~ใครจัดนักเรียนเข้าวิชา~~ ✅ **ทำแล้ว 2026-09-20** — เฟส 1 DB (`5beea08`,`bbb9a01`) · เฟส 2 หน้าจัดตารางแอดมิน (`230a65f`,`55d6a3e`,`71d54cd`) · prod 4.8–4.13 · นักเรียน ม.1/1 เห็นวิชาเอง, แอดมินจัดคาบบน iPhone ได้จริง · **ค้าง**: เฟส 3 ซ่อนปุ่มฝั่งครู, ช่องวิชาที่สอนในหน้าครู (ดู `BRIEF_D6_ADMIN_TIMETABLE_ENROLLMENT.md` §5) | — | — |
