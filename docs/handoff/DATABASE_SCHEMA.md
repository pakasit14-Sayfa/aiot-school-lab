...
_Live dump from local Supabase, regenerated 2026-09-07 after applying all migrations through `20260907020000_school_report_register.sql`._

Generated by `./scripts/dump_schema.sh` — do not hand-edit.

Total relations: 102 (100 tables, 2 views/materialized views)
