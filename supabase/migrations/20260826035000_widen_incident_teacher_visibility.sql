-- =====================================================================
-- Migration: Widen Incident Report Teacher Visibility & Notification Scope
-- Fixes scope gap where incidents reported with custom/elective rooms
-- or by elective students were invisible to teachers.
-- =====================================================================
...
drop function if exists acknowledge_incident_report(text, uuid);
drop function if exists assign_incident_report(text, uuid, uuid);
drop function if exists add_incident_action(text, uuid, text);
drop function if exists escalate_incident_report(text, uuid);
drop function if exists close_incident_report(text, uuid, incident_resolution_type, text);
