-- =====================================================================
-- Migration: Multi-Role Auth Core (auth_sign_in multi-role check & auth_select_role RPC)
-- =====================================================================
...
revoke all on function public.auth_sign_in(text, text, text, text) from public;
grant execute on function public.auth_sign_in(text, text, text, text) to anon, authenticated, service_role;

revoke all on function public.auth_select_role(text, role_type, uuid, text, text) from public;
grant execute on function public.auth_select_role(text, role_type, uuid, text, text) to anon, authenticated, service_role;
