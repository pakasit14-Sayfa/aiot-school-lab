-- Migration: 20260824140000_fix_session_actor_attendance_cctv.sql
-- Description: Fix get_session_actor assignment check across Attendance & CCTV RPCs to return clean 'invalid_session'
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE user_id = p_user_id
      ...
      AND role IN ('teacher', 'school_admin', 'executive', 'facility_manager', 'technician', 'super_admin')
  ) THEN
