...
class _SchoolEncouragementCardState extends State<SchoolEncouragementCard> {
  ...
  // จริงรองรับเลย เหลือแค่คำคมทั่วไปที่ไม่ได้อ้างว่าเป็นข้อมูลจริง — การใช้
  // พลังงานจริงย้ายไปอยู่ที่ SchoolUtilityTrendCard แทน (เป็นกราฟ ต้องการพื้นที่
  // มากกว่าที่ carousel เล็กๆ นี้ให้ได้ และไม่ควรเลื่อนผ่านอัตโนมัติทุก 4 วิ)
