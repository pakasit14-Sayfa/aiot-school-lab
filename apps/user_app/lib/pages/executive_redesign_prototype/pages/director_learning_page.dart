        ...
        child: Column(
          ...
          children: [
            ...
            if (controller.loading)
              card('กำลังโหลดข้อมูลนักเรียน', [const LinearProgressIndicator()])
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${t.studentCount} คน · ${t.roomCount} ห้องเรียน'),
                        Text(
                  ...
                  children: [
                    ...
                    for (final status in statuses)
                      ChoiceChip(
                        ...
                        onSelected: (_) => setState(() => caseStatus = status),
                      ),
                  ],
                ),
                const SizedBox(height: 12),
            ...
            card('งานติดตามที่ยังไม่รองรับ', [
              ...
              const Wrap(
                ...
                runSpacing: 8,
                children: [
                  OutlinedButton(onPressed: null, child: Text('สั่งการติดตาม')),
                  OutlinedButton(
                    onPressed: null,
