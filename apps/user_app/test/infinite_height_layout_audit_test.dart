...
void main() {
  ...
  group('Executive Prototype Layout Audit (Desktop & Mobile)', () {
    ...
    testWidgets('DirectorLearningPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorLearningPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorLearningPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorTeachersPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorTeachersPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorTeachersPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorClassroomsPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorClassroomsPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorClassroomsPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorMeetingsPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorMeetingsPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorMeetingsPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorAcademicCalendarPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorAcademicCalendarPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorAcademicCalendarPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorCctvPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorCctvPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorCctvPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorEnvironmentPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorEnvironmentPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorEnvironmentPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorReportsPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorReportsPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorReportsPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorNotificationsPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorNotificationsPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorNotificationsPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('DirectorSettingsPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const DirectorSettingsPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const DirectorSettingsPage(), mobileSize));
      await tester.pump();
    });
  });
  ...
  group('Parent Prototype Layout Audit (Desktop & Mobile)', () {
    testWidgets('ParentLearningPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const ParentLearningPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const ParentLearningPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('ParentDashboardPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const ParentDashboardPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const ParentDashboardPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('ParentAttendancePage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const ParentAttendancePage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const ParentAttendancePage(), mobileSize));
      await tester.pump();
    });

    testWidgets('ParentAcademicCalendarPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const ParentAcademicCalendarPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const ParentAcademicCalendarPage(), mobileSize));
      await tester.pump();
    });

    testWidgets('ParentSchedulePage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const ParentSchedulePage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const ParentSchedulePage(), mobileSize));
      await tester.pump();
    });

    testWidgets('ParentSettingsPage (Desktop & Mobile)', (tester) async {
      await tester.pumpWidget(createTestWidget(const ParentSettingsPage(), desktopSize));
      await tester.pump();
      await tester.pumpWidget(createTestWidget(const ParentSettingsPage(), mobileSize));
      await tester.pump();
    });
  });
}
