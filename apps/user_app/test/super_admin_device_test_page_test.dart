...
void main() {
  ...
  testWidgets(
    'SuperAdminDeviceTestPage states its real scope and the initial unmeasured state',
    (tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(home: SuperAdminDeviceTestPage()),
      );
      ...
      expect(
        find.text('ทดสอบอุปกรณ์และระบบ (Device Diagnostics)'),
        findsOneWidget,
      );
