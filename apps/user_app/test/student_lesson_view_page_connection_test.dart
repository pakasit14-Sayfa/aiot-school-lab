...
void main() {
  ...
  testWidgets(
    'opening a never-started lesson records 10%, not a fabricated 50%',
    (tester) async {
  ...
  testWidgets(
    'opening a lesson already past 10% does not rewrite its progress',
    (tester) async {
      var calls = 0;
      await _pump(
        tester,
  ...
  testWidgets(
    'marking complete calls the real RPC and flips the UI to the completed state',
    (tester) async {
  ...
  testWidgets(
    'a lesson already marked complete shows the completed state, not the mark-complete button',
    (tester) async {
  ...
  testWidgets(
    'a failed mark-complete shows an honest message, no leaked exception text',
    (tester) async {
      await _pump(
        tester,
  ...
  testWidgets(
    'a failed lesson load shows an honest error, no leaked exception text',
    (tester) async {
      await _pump(
        tester,
        getLesson: (_) async =>
