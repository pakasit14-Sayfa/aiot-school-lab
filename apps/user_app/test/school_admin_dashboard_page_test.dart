...
void main() {
  ...
  testWidgets(
    'SchoolAdminDashboardPage desktop navigates to core batch 1 and batch 2 pages',
    (tester) async {
  ...
  testWidgets(
    'SchoolAdminDashboardPage desktop navigates to operational pages and profile',
    (tester) async {
      tester.view.physicalSize = const Size(1400, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
  ...
  testWidgets(
    'SchoolAdminDashboardPage mobile opens drawer and navigates cleanly',
    (tester) async {
  ...
  testWidgets('the last four sidebar rows open the page their label says', (
    ...
    Future<void> open(String label) async {
      ...
      expect(
        item,
        findsOneWidget,
        reason: '$label ต้องอยู่ใน sidebar แถวเดียว',
      );
